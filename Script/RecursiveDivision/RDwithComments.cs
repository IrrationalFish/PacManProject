...
public class RDwithComments : MonoBehaviour {

    public GameObject cell;
    public Transform mazeParent;
    public static int xMax = 41;
    public static int yMax = 41;
    ...
    void Start() {
        ...
        genBoundary();
        StartCoroutine(genMaze(1, 1, xMax - 2, xMax - 2));
    }
    ...
    private void genBoundary() {
        ...
        for (int i = 0; i < xMax; i++) {
            ...
            //singleCell.GetComponent<DelayCube>().setPosition(new Vector3(i, 0, 0));
            //DelayCube.increaseNoOfCubes();
            ...
            //singleCell.GetComponent<DelayCube>().setPosition(new Vector3(i, yMax - 1, 0));
            //DelayCube.increaseNoOfCubes();
            //singleCell.transform.parent = mazeParent;
        ...
        for (int i = 0; i < yMax; i++) {
            ...
            singleCell.GetComponent<DelayCube>().setPosition(new Vector3(0, i, 0));
            //DelayCube.increaseNoOfCubes();
            singleCell.transform.parent = mazeParent;
            cells[0, i] = singleCell;

            singleCell = Instantiate(cell, new Vector3(xMax - 1, i, 0), new Quaternion());
            singleCell.GetComponent<DelayCube>().setPosition(new Vector3(xMax - 1, i, 0));
            //DelayCube.increaseNoOfCubes();
            singleCell.transform.parent = mazeParent;
    ...
    private IEnumerator genMaze(int x, int y, int height, int width) {
        ...
        for (int i = y; i < y + height; i++) {
            if (cells[xPos, i] == null) {
                ...
                //GameObject singleCell = Instantiate(cell, new Vector3(xMax + 10, i, 0), new Quaternion());
                //singleCell.GetComponent<DelayCube>().setPosition(new Vector3(xPos, i, 0));
                //singleCell.transform.parent = mazeParent;
                //DelayCube.increaseNoOfCubes();
                ////singleCell.GetComponent<DelayCube>().setIsBoundary(false);
        ...
        for (int i = x; i < x + width; i++) {
            if (cells[i, yPos] == null) {
                ...
                //GameObject singleCell = Instantiate(cell, new Vector3(i, yMax + 10, 0), new Quaternion());
                //singleCell.GetComponent<DelayCube>().setPosition(new Vector3(i, yPos, 0));
                //singleCell.transform.parent = mazeParent;
                //DelayCube.increaseNoOfCubes();
                ////singleCell.GetComponent<DelayCube>().setIsBoundary(false);      //还在移动
    ...
    //public static GameObject[,] getCells() {
    //    return cells;
    //}
}
